...
| <a id="gen-ai-agent-iteration-budget-limit" href="#gen-ai-agent-iteration-budget-limit">`gen_ai.agent.iteration_budget.limit`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | Maximum iterations configured for this agent invocation. [2] | `10`; `25`; `50` |
...
| <a id="gen-ai-agent-token-budget-limit" href="#gen-ai-agent-token-budget-limit">`gen_ai.agent.token_budget.limit`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | Cumulative token budget configured for this agent invocation. [3] | `50000`; `100000`; `500000` |
...
**[2] `gen_ai.agent.iteration_budget.limit`:** The maximum number of iterations configured for this agent
...
**[3] `gen_ai.agent.token_budget.limit`:** The cumulative token budget (input + output, across all inference
