...
| Value | Description | Stability |
| --- | --- | --- |
| `local` | The emitting component computed the value itself. [42] | ![Development](https://img.shields.io/badge/-development-blue) |
| `provider` | The cost value was present in the response the client received. [43] | ![Development](https://img.shields.io/badge/-development-blue) |

**[42]:** No cost was present in the response; the emitting component
...
**[43]:** The cost value was present in the response the instrumented
