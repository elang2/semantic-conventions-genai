...
| Value | Description | Stability |
| --- | --- | --- |
| `estimate` | Cost is a rough estimate (e.g. from cached pricing that may be stale). [37] | ![Development](https://img.shields.io/badge/-development-blue) |
| `pricing_table` | Cost computed from token counts and a locally configured pricing table. [38] | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[37]:** Enrichment MUST NOT replace a cost value already recorded by
an in-path component. This source is intended to fill an
absence, not to override a provider or pricing_table value.

**[38]:** The recorded value reflects the pricing table in force at the
