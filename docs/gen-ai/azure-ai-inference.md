...
| [`gen_ai.usage.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of prompt tokens as reported in the usage prompt_tokens property of the response. [30] | `100` |
| [`gen_ai.usage.output_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of completion tokens as reported in the usage completion_tokens property of the response. [31] | `180` |
...
| Value | Description | Stability |
| --- | --- | --- |
| `local` | Cost computed by the emitting instrumentor from a pricing table or model. [43] | ![Development](https://img.shields.io/badge/-development-blue) |
| `provider` | Cost value received from upstream (provider, gateway, or broker). [44] | ![Development](https://img.shields.io/badge/-development-blue) |

**[43]:** The recorded value reflects the pricing knowledge in force at
the time cost was computed and is not expected to be recomputed
from token counts and a later pricing table.

**[44]:** Use this when the cost was not computed by the emitting
