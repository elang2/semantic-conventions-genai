...
| [`server.port`](https://github.com/open-telemetry/semantic-conventions/blob/v1.44.0/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If not default (443). | int | GenAI server port. [13] | `80`; `8080`; `443` |
| [`azure.resource_provider.namespace`](https://github.com/open-telemetry/semantic-conventions/blob/v1.44.0/docs/registry/attributes/azure.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | [Azure Resource Provider Namespace](https://learn.microsoft.com/azure/azure-resource-manager/management/azure-services-resource-providers) as recognized by the client. [14] | `Microsoft.CognitiveServices` |
...
| [`gen_ai.usage.cost.amount`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | double | The monetary cost of a single GenAI operation. [22] | `0.0023`; `0.015`; `0.42` |
| [`gen_ai.usage.cost.source`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The source of the cost value. [23] | `provider`; `pricing_table`; `estimate` |
| [`gen_ai.usage.input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of prompt tokens as reported in the usage prompt_tokens property of the response. [24] | `100` |
| [`gen_ai.usage.output_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of completion tokens as reported in the usage completion_tokens property of the response. [25] | `180` |
...
| [`gen_ai.prompt.variable`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | The variables supplied to the prompt template, the `<key>` being the variable name, the value being the variable value. [30] | `Alice`; `French` |
...
**[14] `azure.resource_provider.namespace`:** When `azure.resource_provider.namespace` attribute is populated, it MUST be set to `Microsoft.CognitiveServices` for all operations performed by Azure AI Inference clients.
...
**[22] `gen_ai.usage.cost.amount`:** The cost in the currency specified by `gen_ai.usage.cost.currency`.
...
**[23] `gen_ai.usage.cost.source`:** Distinguishes provider-reported costs from locally computed values.
...
**[30] `gen_ai.prompt.variable`:** Prompt templates are parameterized with variables that are filled in
...
| Value | Description | Stability |
| --- | --- | --- |
| `estimate` | Cost is a rough estimate (e.g. from cached pricing that may be stale). [34] | ![Development](https://img.shields.io/badge/-development-blue) |
| `pricing_table` | Cost computed from token counts and a locally configured pricing table. [35] | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[34]:** Enrichment MUST NOT replace a cost value already recorded by
an in-path component. This source is intended to fill an
absence, not to override a provider or pricing_table value.

**[35]:** The recorded value reflects the pricing table in force at the
