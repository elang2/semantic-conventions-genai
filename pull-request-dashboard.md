...
llm: pr-conversation -> author (The author said they will copy the approach from another PR, so the thread is waiting on the author to make the follow-up change.)
