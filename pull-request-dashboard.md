...
| [Align attributes between invoke_agent.internal and execute_tool spans and metrics (#322)](https://github.com/open-telemetry/semantic-conventions-genai/pull/322) | lmolkova | trask&nbsp;✅ | ✅ | ✅ | 9h |
...
PR #179
llm: PRRT_kwDOSUeMrM6Kz7CF -> author (The only comment is from a reviewer flagging a deprecated OpenAI prompt template feature, so the author needs to respond or adjust the scenario.)
