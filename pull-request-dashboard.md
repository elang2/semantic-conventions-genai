...
|---|---|---|:---:|:---:|:---:|
| [Update dependency google-adk to v2 (#173)](https://github.com/open-telemetry/semantic-conventions-genai/pull/173) | app/renovate | MikeGoldsmith&nbsp;✅ | ✅ | ✅ | 28d |
...
| [semconv for compaction (#162)](https://github.com/open-telemetry/semantic-conventions-genai/pull/162) | eternalcuriouslearner | JWinermaSplunk&nbsp;✅<br>lmolkova&nbsp;✅<br>MikeGoldsmith&nbsp;✅<br>trask | ✅ | ✅ | 13h |

## Waiting on reviewers

| PR | Author | Reviewers | CI | Conflicts | Age |
|---|---|---|:---:|:---:|:---:|
| [gen-ai: make input-messages BlobPart content optional and add stripped_reason (#144)](https://github.com/open-telemetry/semantic-conventions-genai/pull/144) | Mandark-droid | lmolkova<br>trask | ✅ | ✅ | 6d |
...
| [Remove gen_ai.provider.name from internal agent spans (#289)](https://github.com/open-telemetry/semantic-conventions-genai/pull/289) | lmolkova | JWinermaSplunk<br>MikeGoldsmith&nbsp;✅<br>trask&nbsp;✅ | ✅ | ✅ | 3d |
...
| [Fix Copilot reviewer aliases in PR dashboard (#316)](https://github.com/open-telemetry/semantic-conventions-genai/pull/316) | trask | MikeGoldsmith&nbsp;✅ | ✅ | ✅ | 15h |
| [Fix Copilot dashboard delegator detection (#317)](https://github.com/open-telemetry/semantic-conventions-genai/pull/317) | trask | MikeGoldsmith&nbsp;✅ | ✅ | ✅ | 15h |
| [Add `gen_ai.request.reasoning.level` attribute (#258)](https://github.com/open-telemetry/semantic-conventions-genai/pull/258) | katsuhisa91 | JWinermaSplunk&nbsp;✅<br>lmolkova<br>trask | ❌ | ✅ | 15h |
| [semconv for a2a protocol (#195)](https://github.com/open-telemetry/semantic-conventions-genai/pull/195) | eternalcuriouslearner | aabmass<br>JWinermaSplunk<br>trask | ✅ | ✅ | 6h |

## Waiting on authors

| PR | Author | Reviewers | CI | Conflicts | Age |
|---|---|---|:---:|:---:|:---:|
| [Add gen_ai.server.inter_token_latency metric (#164)](https://github.com/open-telemetry/semantic-conventions-genai/pull/164) | Jwrede | Cirilla-zmh<br>lmolkova&nbsp;💬<br>trask | ✅ | ❌ | 29d |
| [gen-ai: add evaluation operation name and gen_ai.evaluate.internal span (#185)](https://github.com/open-telemetry/semantic-conventions-genai/pull/185) | hippoley | Cirilla-zmh&nbsp;💬<br>Copilot&nbsp;💬<br>singankit&nbsp;💬 | ❌ | ✅ | 27d |
| [gen-ai: add gen_ai.response.id to deepeval evaluation result event (#184)](https://github.com/open-telemetry/semantic-conventions-genai/pull/184) | hippoley | lmolkova&nbsp;✅<br>MikeGoldsmith&nbsp;🔴<br>trask | ✅ | ✅ | 20d |
| [Add modality, cache, and phase breakdowns for token usage (#197)](https://github.com/open-telemetry/semantic-conventions-genai/pull/197) | trask | alexmojaki&nbsp;💬<br>lmolkova&nbsp;💬<br>Nik-Reddy&nbsp;💬 | ✅ | ❌ | 17d |
| [gen-ai: add optional byte_size to multimodal content parts (#143)](https://github.com/open-telemetry/semantic-conventions-genai/pull/143) | Mandark-droid | Cirilla-zmh<br>trask&nbsp;💬 | ✅ | ❌ | 15d |
| [Add gen_ai.invoke_agent.server span (SERVER kind) (#252)](https://github.com/open-telemetry/semantic-conventions-genai/pull/252) | singankit | Cirilla-zmh&nbsp;💬<br>Copilot&nbsp;💬<br>trask | ✅ | ❌ | 12d |
| [Add gen_ai.agent.invocation.id attribute for invoke_agent spans (#250)](https://github.com/open-telemetry/semantic-conventions-genai/pull/250) | singankit | lmolkova&nbsp;💬<br>MikeGoldsmith&nbsp;🔴<br>trask | ✅ | ❌ | 6d |
...
| [Add workflow node convention (#188)](https://github.com/open-telemetry/semantic-conventions-genai/pull/188) | RKest | aabmass<br>lmolkova&nbsp;🔴<br>trask | ✅ | ❌ | 6d |
...
| [Add gen_ai.agent.request.size and gen_ai.agent.response.size metrics (#202)](https://github.com/open-telemetry/semantic-conventions-genai/pull/202) | pvlsirotkin | lmolkova&nbsp;💬<br>MikeGoldsmith&nbsp;🔴<br>trask | ✅ | ❌ | 6d |
...
| [Propose GenAI agent entity (#270)](https://github.com/open-telemetry/semantic-conventions-genai/pull/270) | aabmass | lmolkova&nbsp;💬⁠✅<br>trask&nbsp;💬 | ✅ | ❌ | 22h |
| [Classify invoke_agent client vs internal by span kind (#296)](https://github.com/open-telemetry/semantic-conventions-genai/pull/296) | trask | Copilot&nbsp;💬<br>copilot-pull-request-reviewer\[bot\]&nbsp;✔️<br>lmolkova&nbsp;✅ | ✅ | ✅ | 16h |
...
| [Add GenAI client metrics to the anthropic reference scenario (#283)](https://github.com/open-telemetry/semantic-conventions-genai/pull/283) | AgentGymLeader | JWinermaSplunk<br>MikeGoldsmith&nbsp;🔴 | ✅ | ✅ | 9m |

## Waiting on external

| PR | Author | Reviewers | CI | Conflicts | Age |
|---|---|---|:---:|:---:|:---:|
| [Update dependency google-genai to v2 (#112)](https://github.com/open-telemetry/semantic-conventions-genai/pull/112) | app/renovate | lmolkova&nbsp;✅ | ❌ | ✅ | 28d |

## Draft pull requests

| PR | Author | Updated |
|---|---|:---:|
| [proposal: agent.threat.detection.* attributes + event (closes #132) (#165)](https://github.com/open-telemetry/semantic-conventions-genai/pull/165) | eeee2345 | 25d |
...
| [feat(gen-ai): add agent authorization observability attributes (#180) (#291)](https://github.com/open-telemetry/semantic-conventions-genai/pull/291) | thebenignhacker | 1d |
...
```text
PR #296
llm: PRRT_kwDOSUeMrM6KDgd- -> author (The reviewer pointed out a misleading variable name and implied a code change is needed; the author needs to update the PR.)
llm: pr-conversation -> none (The latest reviewer comment is an approval with no requested follow-up, so the thread is closed.)
...
PR #289
llm: PRRT_kwDOSUeMrM6JXu8q -> reviewer (The only comment is from the author, so by the thread heuristic the reviewer/maintainer has the next response.)

PR #283
llm: PRRT_kwDOSUeMrM6KQIPN -> author (A reviewer asked to extend the scenario to exercise an error path and capture `error.type`; the ball is with the PR author to make that change or respond.)
llm: PRRT_kwDOSUeMrM6KQI8B -> author (Reviewer requested a code change to move the count increment outside the observations loop, so the PR author needs to update the implementation.)
llm: PRRT_kwDOSUeMrM6KQLun -> author (A reviewer asked for code changes before `run_chat` and to set bucket bounds, so the author needs to update the PR.)
llm: PRRT_kwDOSUeMrM6KQOz0 -> author (A reviewer suggested changing `parse_results.py` to warn and return when `data_points` is not a dict, so the author needs to respond by implementing or addressing it.)
llm: PRRT_kwDOSUeMrM6KQQom -> author (The latest reviewer comment questions whether the items already exist in `METRIC_SPECS`, so the author needs to confirm or adjust the code.)
llm: PRRT_kwDOSUeMrM6KQR4l -> author (A reviewer asked for a change (“log a warning”) and the author has not replied yet, so the next action is on the author.)
llm: pr-conversation -> author (The reviewer asked for added tests and left suggestions, so the PR author needs to respond and make the requested changes.)

PR #270
llm: PRRT_kwDOSUeMrM6I6cGM -> author (The latest comment is from a reviewer/approver and adds a proposed direction for the unresolved conflict, so the PR author needs to respond or adjust the PR.)
...
PR #195
llm: pr-conversation -> reviewer (The latest comment is from the author asking @pwkowalski to take another look, so the ball is back with a reviewer/maintainer.)
...
PR #173
llm: pr-conversation -> none (The reviewer’s last comment is a closing acknowledgement that the issue now works as expected, with no follow-up requested.)
...
PR #98
llm: pr-conversation -> author (The latest comment is from a reviewer and raises open questions about edge cases, so the PR author needs to जवाब/decide whether to address or defer them.)
