...
| [Remove gen_ai.provider.name from internal agent spans (#289)](https://github.com/open-telemetry/semantic-conventions-genai/pull/289) | lmolkova | JWinermaSplunk | ✅ | ❌ | 1d |
...
| [gen-ai: add run guardrail span and security finding (#262)](https://github.com/open-telemetry/semantic-conventions-genai/pull/262) | nagkumar91 | aabmass<br>trask | ✅ | ✅ | 44m |
...
| [Propose GenAI agent entity (#270)](https://github.com/open-telemetry/semantic-conventions-genai/pull/270) | aabmass | lmolkova&nbsp;💬⁠✅<br>trask&nbsp;💬 | ✅ | ❌ | 3d |
...
| [Add GenAI client metrics to the anthropic reference scenario (#283)](https://github.com/open-telemetry/semantic-conventions-genai/pull/283) | AgentGymLeader | Copilot&nbsp;💬 | ✅ | ✅ | 54m |
...
PR #283
llm: PRRT_kwDOSUeMrM6JoXSQ -> author (A reviewer flagged a potential metric-coverage bug and requested the metric path avoid falling back to unrelated span/event attributes; the author needs to respond or update the code.)
...
PR #262
llm: pr-conversation -> reviewer (The author made the latest reply and summarized another update; the ball is back with reviewers to assess the changes and decide whether more feedback remains.)
