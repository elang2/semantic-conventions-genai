...
| [Fix Copilot reviewer aliases in PR dashboard (#316)](https://github.com/open-telemetry/semantic-conventions-genai/pull/316) | trask |  | ✅ | ✅ | 10h |
...
| [Classify invoke_agent client vs internal by span kind (#296)](https://github.com/open-telemetry/semantic-conventions-genai/pull/296) | trask | Copilot&nbsp;💬<br>copilot-pull-request-reviewer\[bot\]&nbsp;✔️<br>lmolkova&nbsp;✅ | ✅ | ✅ | 10h |
...
PR #98
llm: pr-conversation -> reviewer (The author’s latest comment asks the reviewer to take another look, so the ball is back with the reviewer.)
