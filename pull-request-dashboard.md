...
| [semconv for compaction (#162)](https://github.com/open-telemetry/semantic-conventions-genai/pull/162) | eternalcuriouslearner | JWinermaSplunk&nbsp;✅<br>lmolkova&nbsp;✅<br>trask&nbsp;💬 | ✅ | ✅ | 5m |
...
| [Classify invoke_agent client vs internal by span kind (#296)](https://github.com/open-telemetry/semantic-conventions-genai/pull/296) | trask | 6h |
...
PR #162
llm: PRRT_kwDOSUeMrM6KCYU- -> author (The latest comment is from the reviewer/approver and proposes wording/precedent, so the author needs to respond or update the PR.)
